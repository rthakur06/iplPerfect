...
function boss(skip: number, name: string): TeamStrength {
  return {
    teamSeasonId: `ALLTIME_${skip}`,
    franchiseId: "ALLTIME",
    season: 0,
    name,
    ...strengthOf(greedyXi(BY_OVR.slice(skip))),
  };
}

export const BOSS_QUALIFIER: TeamStrength = boss(70, "IPL All-Stars");
export const BOSS_SEMI_FINAL: TeamStrength = boss(28, "Hall of Fame XI");
export const BOSS_FINAL: TeamStrength = boss(0, "The All-Time XI");
